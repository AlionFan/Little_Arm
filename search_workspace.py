...
# 定义关节角度范围和步长
angle_range = np.arange(-np.pi, np.pi, 0.1)  # 从 -π 到 π，步长 0.1 弧度
...
p.addUserDebugPoints(
    pointPositions=end_effector_positions,
    pointColorsRGB=[point_color] * len(end_effector_positions),
